...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Vib-Ribbon",
    .project_root_env = "VIB_RIBBON_PROJECT_ROOT",
    .build_dir_env = "VIB_RIBBON_BUILD_DIR",
    .force_setup_env = "VIB_RIBBON_FORCE_SETUP",
    .psxrecomp_cli_relpath = "psxrecomp/psxrecomp_cli.py",
    .seed_cfg_relpath = "game.toml",
    .game_toml_relpath = "game.toml",
    .gen_marker_relpath = "generated/SCES_028.73_dispatch.c",
    .build_dir_name = "build-release",
    .cmake_target = "psx-runtime",
    .exe_basename = "Vib_Ribbon_Recompiled",
    .prepare_note =
